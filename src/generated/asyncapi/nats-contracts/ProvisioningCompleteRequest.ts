class ProvisioningCompleteRequest {
  ...
  private _sendFrequencyMs: number;
  ...
  constructor(input: {
    ...
    this._sendFrequencyMs = input.sendFrequencyMs;
  ...
  get sendFrequencyMs(): number {
    return this._sendFrequencyMs;
  }
  set sendFrequencyMs(sendFrequencyMs: number) {
    this._sendFrequencyMs = sendFrequencyMs;
  }
