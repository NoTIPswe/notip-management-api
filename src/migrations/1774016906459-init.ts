...
export class Init1774016906459 implements MigrationInterface {
  name = 'Init1774016906459';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "gateways_metadata" ("gateway_id" uuid NOT NULL, "name" character varying NOT NULL, "status" "public"."gateways_metadata_status_enum" NOT NULL DEFAULT 'gateway_offline', "last_seen_at" TIMESTAMP, "send_frequency_ms" bigint NOT NULL, CONSTRAINT "UQ_248355bb9e92f0c78d4680bacda" UNIQUE ("name"), CONSTRAINT "PK_729d7d97397c3627c5dfb615156" PRIMARY KEY ("gateway_id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "gateways" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenant_id" uuid NOT NULL, "factory_id" character varying NOT NULL, "factory_key_hash" text, "provisioned" boolean NOT NULL DEFAULT false, "model" character varying NOT NULL, "firmware_version" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_d67ac9bac23aa38cacb630bd360" UNIQUE ("factory_id"), CONSTRAINT "PK_b53153080a6907017cf44cb7f58" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "api_clients" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenant_id" uuid NOT NULL, "name" character varying NOT NULL, "keycloak_client_id" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_ef2d5ef0eb5e9a6ddc67cfa310e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_alert_config_gateway_override" ON "alert_configs" ("gateway_id") WHERE "gateway_id" IS NOT NULL`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_alert_config_tenant_default" ON "alert_configs" ("tenant_id") WHERE "gateway_id" IS NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_alert_config_tenant_default"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_alert_config_gateway_override"`,
    );
